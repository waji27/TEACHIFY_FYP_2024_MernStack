          ...
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <Link to="/" className="flex items-center">
              <img
                ...
                alt="Flowbite Logo"
              />
              <span className="text-primary-950 self-center text-xl font-semibold whitespace-nowrap dark:text-white">
                TEACHIFY
              </span>
            </Link>
            <div className="flex items-center lg:order-2">
              {!auth?.user ? (
                <>
                  <Link
                    to="/login"
                    className="text-gray-500 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"
                  >
                    Log in
                  </Link>
                  <Link
                ...
                <>
                  ...
                  <Link
                    ...
                    to="/login"
                    className="text-gray-800 bg-red-400 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"
                  >
                    Log out
                  </Link>
                </>
